...
import { Text, View, FlatList, Image, Modal, Button, Dimensions, Picker, Alert, TouchableOpacity } from 'react-native';
import styles from './styles/RenderModalStyles';

const windowWidth = Dimensions.get('window').width - 40;

const RenderModal = ({ toggleModal, showModal, item, addCartHandler, fetchCartData }) => {
